...
If the server has sent any extension responses that the client does not recognize, or are in
...
This takes an array of offer params and returns a *ServerSession*, whose interface is defined below.
