...
To connect via a proxy, set the `proxy` option to the HTTP origin of the proxy, including any
...
Both the server- and client-side classes allow an options object to be passed in at initialization
time, for example:
